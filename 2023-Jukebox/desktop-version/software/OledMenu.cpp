...
void Menu::initTemplates() {
  ...
  int i = 0;
  (*templates)["Audio"]["Source"][i++] = "SINE";
  (*templates)["Audio"]["Source"][i++] = "SAWTOOTH";
  (*templates)["Audio"]["Source"][i++] = "SQUARE";
  (*templates)["Audio"]["Source"][i++] = "TRIANGLE";
  ...
  const char *AUDIO_MOD_LIST[] = {"Source Mod", "Filter Frq", "Filter Res", 
    "Effect Mod", "Gain Mod"};
  for (int j = 0; j < NUM_AUDIO_MODS; j++) {
    i = 0;
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "VCO Knob";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "VCF Knob";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "VCA Knob";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "Vol Knob";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "X";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "Y";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "Angle";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "Radius";
    (*templates)["Audio"][AUDIO_MOD_LIST[j]][i++] = "MIDI";
  }
  ...
  (*templates)["LED"]["Mode"][0] = "Off";
  (*templates)["LED"]["Mode"][1] = "Rainbow";
  (*templates)["LED"]["Mode"][2] = "FFT";
 
  (*templates)["LED"]["Audio Source"][0] = "1";
  (*templates)["LED"]["Audio Source"][1] = "2";
  (*templates)["LED"]["Audio Source"][2] = "3";
  (*templates)["LED"]["Audio Source"][3] = "4";
...
void Menu::updateItemList() {
  ...
  if (currentSubMenu < 4) {
    ...
    setItemList = (*templates)["LED"][getText(setRowSelected)];
